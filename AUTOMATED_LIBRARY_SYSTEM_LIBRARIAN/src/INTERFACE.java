...
public class INTERFACE extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("LIBRARY MANAGEMENT SYSTEM(For Librarian)");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 270, 830, 50));

        jLabel2.setFont(new java.awt.Font("Yu Gothic", 1, 48)); // NOI18N
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sltc.PNG"))); // NOI18N
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 340, -1, 110));
        ...
        getContentPane().add(pbar, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 470, 280, 20));
